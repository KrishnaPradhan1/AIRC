                ...
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
                    ...
                    <div className="flex flex-col gap-6 text-center lg:text-left">
                        ...
                        <motion.h1
                            ...
                            className="text-4xl lg:text-6xl tracking-tight font-bold text-gray-900"
                        >
                        ...
                        >
                            <Button size="lg" asChild className="group bg-blue-600 hover:bg-blue-700">
                        ...
                        >
                            ...
                            >
                                <span className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">AI-Powered</span>
                            ...
                            <motion.div
                                ...
                                className="flex flex-col gap-1 p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-blue-100"
                            >
                                <span className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">95%</span>
                            ...
                            <motion.div
                                ...
                                className="flex flex-col gap-1 p-4 rounded-lg bg-white/50 backdrop-blur-sm border border-blue-100"
                            >
                                <span className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">&lt;5s</span>
                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="text-sm font-semibold text-gray-900">AI Matching</div>
