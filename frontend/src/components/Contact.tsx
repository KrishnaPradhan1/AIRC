        ...
        <section id="contact" className="py-20 lg:py-32 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="max-w-5xl mx-auto grid gap-8 lg:grid-cols-5">
                    ...
                    >
                        <h3 className="text-2xl mb-6 font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                            Send us a Message
                        </h3>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            >
                                <Button
                                    type="submit"
                                    size="lg"
                                    className="w-full md:w-auto group relative overflow-hidden bg-blue-600 hover:bg-blue-700"
